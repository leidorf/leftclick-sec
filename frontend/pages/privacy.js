          ...
          <div className="text-pretty max-w-2xl">
            ...
            <div className="text-sm mt-4">
              ...
              <ol className="list-decimal">
                <div className="mb-4">
                  <li className="text-lg">Information LCS Collects</li>
                ...
                <div className="mb-4">
                  <li className="text-lg">How LCS Uses Your Information</li>
                ...
                <div className="mb-4">
                  <li className="text-lg">Data Security</li>
                ...
                <div className="mb-4">
                  <li className="text-lg">Data Retention</li>
                ...
                <div className="mb-4">
                  <li className="text-lg">Changes to This Privacy Policy</li>
                ...
                <div className="mb-4">
                  <li className="text-lg">Contact LCS</li>
