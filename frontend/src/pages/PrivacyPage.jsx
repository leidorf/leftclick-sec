        ...
        <div className="text-pretty max-w-2xl min-w-60">
          ...
          <div className="text-sm mt-4">
            <p>
              ...
              <br />
              LeftClick Sec, also known as LCS, is committed to protecting your
              privacy. This Privacy Policy explains how we collect, use and
              handle your information when you use our services.
            </p>
            ...
            <ol className="list-decimal">
              <div className="mb-4">
                ...
                LCS only collects the minimum amount of information necessary to
                provide our services effectively. Specifically:
                <ol>
                  ...
                  collect or store any other personally identifiable information
                  from users.
                </ol>
              </div>
              <div className="mb-4">
                ...
                <ul className="list-disc">
                  ...
                  <li>
                    <strong>Logging Suspicious Domains:</strong> The purpose of
                    maintaining a database of suspicious domains is security.
                  </li>
                </ul>
              </div>
              <div className="mb-4">
                ...
                LCS does <span className="text-red-600 font-bold">NOT</span>{" "}
                sell, share, or disclose your information to any third parties.
              </div>
              <div className="mb-4">
                <li className="text-lg">
                ...
                believe your domain or URL has been incorrectly flagged, you can
                contact LCS to request a review.
              </div>
              <div className="mb-4">
                <li className="text-lg">
                  <strong>Data Security</strong>
                </li>
                LCS implements reasonable measures to secure stored information
                about flagged domains, including technical safeguards to prevent
                unauthorized access.
              </div>
              <div className="mb-4">
                <li className="text-lg">
              ...
              <div className="mb-4">
                ...
                LCS may update this Privacy Policy from time to time to reflect
                changes in its practices or legal obligations. Any updates will
                be posted on this page and will include an updated effective
                date.
              </div>
              <div className="mb-4">
                <li className="text-lg">
                ...
                or believe your domain has been flagged in error, please contact
                LCS at:
                <ul>
                  <li>
                    <Link
